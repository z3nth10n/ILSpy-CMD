...
namespace Mono.CSharp
{
	...
	{
		private Nullable.Unwrap expr_unwrap;
		...
		private void EmitConstantMatch(EmitContext ec)
		{
	...
	public class Binary : Expression, IDynamicBinder
	{
		...
		{
			private MethodSpec equal_method, inequal_method;
		...
		private static CSharp.Operator.OpType ConvertBinaryToUserOperator(Operator op)
		{
			switch (op)
			{
				case Operator.Addition:
	...
	{
		private Expression expr, true_expr, false_expr;
	...
	public class New : ExpressionStatement, IMemoryLocation
	{
		...
		private bool DoEmitTypeParameter(EmitContext ec)
		{
	...
	public class ArrayAccess : Expression, IDynamicAssign, IMemoryLocation
	{
		...
		private SLE.Expression[] MakeExpressionArguments(BuilderContext ctx)
		{
			using (ctx.With(BuilderContext.Options.CheckedScope, true))
			{
	...
	internal class IndexerExpr : PropertyOrIndexerExpr<IndexerSpec>, OverloadResolver.IBaseMembersProvider
	{
		...
		#endregion IBaseMembersProvider Members
	}
	...
	public class NewInitialize : New
	{
		...
		private sealed class InitializerTargetExpression : Expression, IMemoryLocation
		{
			...
			#endregion IMemoryLocation Members
		}
