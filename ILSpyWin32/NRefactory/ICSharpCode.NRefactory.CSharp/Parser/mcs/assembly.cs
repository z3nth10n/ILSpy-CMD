...
namespace Mono.CSharp
{
	...
	public abstract class AssemblyDefinition : IAssemblyDefinition
	{
		...
		private byte[] public_key, public_key_token;
		...
		private string vi_product, vi_product_version, vi_company, vi_copyright, vi_trademark;
	...
	public class AssemblyResource : IEquatable<AssemblyResource>
	{
		...
		#endregion IEquatable<AssemblyResource> Members
	}
