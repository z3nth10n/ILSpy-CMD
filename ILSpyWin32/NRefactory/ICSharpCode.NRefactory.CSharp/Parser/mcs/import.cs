...
namespace Mono.CSharp
{
	public abstract class MetadataImporter
	{
		...
		{
			private static readonly bool[] single_attribute = { true };
		...
		private TypeParameterSpec[] CreateGenericParameters(MetaType type, TypeSpec declaringType)
		{
		...
		private TypeParameterSpec[] CreateGenericParameters(int first, MetaType[] tparams)
		{
		...
		private TypeSpec[] CreateGenericArguments(int first, MetaType[] tparams, DynamicTypeReader dtype)
		{
			++dtype.Position;
		...
		private TypeSpec CreateType(MetaType type, DynamicTypeReader dtype, bool canImportBaseType)
		{
		...
		private TypeParameterSpec CreateTypeParameter(MetaType type, TypeSpec declaringType)
		{
			Variance variance;
		...
		private void ImportTypeBase(TypeSpec spec, MetaType type)
		{
		...
		private void ImportTypeParameterTypeConstraints(TypeParameterSpec spec, MetaType type)
		{
		...
		private TypeSpec ImportType(MetaType type, DynamicTypeReader dtype)
		{
			if (type.HasElementType)
			{
				var element = type.GetElementType();
		...
		private static bool IsMissingType(MetaType type)
		{
#if STATIC
	...
	internal class ImportedParameterMemberDefinition : ImportedMemberDefinition, IParametersMember
	{
	...
	internal class ImportedMethodDefinition : ImportedParameterMemberDefinition, IMethodDefinition
	{
	...
	internal class ImportedGenericMethodDefinition : ImportedMethodDefinition, IGenericMethodDefinition
	{
	...
	internal class ImportedTypeDefinition : ImportedDefinition, ITypeDefinition
	{
	...
	internal class ImportedTypeParameterDefinition : ImportedDefinition, ITypeDefinition
	{
