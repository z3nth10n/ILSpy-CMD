...
namespace Mono.CSharp
{
	...
	abstract public class PropertyBase : PropertyBasedMember
	{
		...
		{
			private static readonly string[] attribute_targets = new string[] { "method", "return" };
		...
		{
			private static readonly string[] attribute_targets = new string[] { "method", "param", "return" };
		...
		private static readonly string[] attribute_targets = new string[] { "property" };
		...
		private PropertyMethod get, set, first;
	...
	public class Property : PropertyBase
	{
		public sealed class BackingField : Field
		{
			...
			private const Modifiers DefaultModifiers = Modifiers.BACKING_FIELD | Modifiers.COMPILER_GENERATED | Modifiers.PRIVATE | Modifiers.DEBUGGER_HIDDEN;
		...
		private static readonly string[] attribute_target_auto = new string[] { "property", "field" };
	...
	public class EventProperty : Event
	{
		...
		private static readonly string[] attribute_targets = new string[] { "event" };
	...
	public class EventField : Event
	{
		...
		private static readonly string[] attribute_targets = new string[] { "event", "field", "method" };
		private static readonly string[] attribute_targets_interface = new string[] { "event", "method" };
	...
	public abstract class Event : PropertyBasedMember
	{
		...
		private AEventAccessor add, remove;
	...
	public class Indexer : PropertyBase, IParametersMember
	{
		public class GetIndexerMethod : GetMethod, IParametersMember
		{
			...
			#endregion IParametersMember Members
		}
		...
		private const Modifiers AllowedInterfaceModifiers =
			Modifiers.NEW;
