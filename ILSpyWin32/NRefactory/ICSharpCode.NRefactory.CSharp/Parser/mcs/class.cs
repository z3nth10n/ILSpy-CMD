...
namespace Mono.CSharp
{
	...
	public abstract class TypeDefinition : TypeContainer, ITypeDefinition
	{
		...
		public struct BaseContext : IMemberContext
		{
			...
			#endregion IMemberContext Members
		}
		...
		private FullNamedExpression base_type_expr; // TODO: It's temporary variable
		...
		private static readonly string[] attribute_targets = new[] { "type" };
		private static readonly string[] attribute_targets_primary = new[] { "type", "method" };
	...
	public abstract class ClassOrStruct : TypeDefinition
	{
		...
		private SecurityType declarative_security;
	...
	{
		private bool is_unmanaged, has_unmanaged_check_done;
		...
		private bool HasExplicitConstructor()
		{
			foreach (var m in Members)
			{
				var c = m as Constructor;
