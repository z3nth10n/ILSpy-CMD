...
namespace Mono.CSharp
{
	...
	public class If : Statement
	{
		...
		private bool true_returns, false_returns;
	...
	{
		public Expression expr;
		private bool iterator_reachable, end_reachable;
	...
	{
		public Expression expr;
		private bool empty, infinite, end_reachable;
	...
	{
		private bool infinite, empty, iterator_reachable, end_reachable;
		private List<DefiniteAssignmentBitSet> end_reachable_das;
	...
	public class SwitchLabel : Statement
	{
		...
		//
		private bool ResolveAndReduce(BlockContext rc)
		{
			if (IsDefault)
				return true;
	...
	public class Switch : LoopStatement
	{
		...
		private Label defaultLabel, nullLabel;
		...
		//
		private Nullable.Unwrap unwrap;
	...
	public abstract class TryFinallyBlock : ExceptionStatement
	{
		...
		private bool prepared_for_dispose, emitted_dispose;
